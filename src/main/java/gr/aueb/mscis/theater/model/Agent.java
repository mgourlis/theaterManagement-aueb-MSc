...
public class Agent {
    ...
    /**
     *Εισάγει έναν ρόλο στους ρόλους του Συντελεστή χρησιμοποιώντας την μέθοδο add
    ...
    /**
     *Αφαιρεί ένα ρόλο από τους ρόλους του Συντελεστή χρησιμοποιώντας την μέθοδο remove
